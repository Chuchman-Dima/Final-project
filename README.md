...
**[Link to Streamlit App](https://ai-fundamentals-final-project-linear-regression-k68n2ch9zachd9.streamlit.app/)**
...
2. **Run the container:**
   ```bash
   docker run -p 8502:8502 dmytrochuchman/ai_fundamentals:streamlit-v1 streamlit run app.py --server.port=8502
   ```

3. **View the app:** Open your browser and go to [http://localhost:8502](http://localhost:8502)
